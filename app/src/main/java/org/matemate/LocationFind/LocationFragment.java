...
import org.matemate.BuildConfig;
import org.matemate.Interface.KakaoAPI;
import org.matemate.Interface.KakaoRetrofit;
...
public class LocationFragment extends Fragment implements OnBackPressedListener {
    ...
    List<Place> placeList; //kakaoAPI로 받아온 placeList저장
